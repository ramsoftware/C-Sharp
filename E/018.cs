	...
	class Program {
		public static void Main() {
			...
			for (int cont=0; cont < Ejemplo.Count; cont++) {
				...
				Console.WriteLine( " tipo: " + Ejemplo[cont].GetType());
			}
			Console.WriteLine("\r\n");
			...
			for (int cont = 0; cont < Ejemplo.Count; cont++) {
				Console.Write(Ejemplo[cont]);
				if (Ejemplo[cont].GetType() == typeof(int)) 
					Console.WriteLine(" es un entero");
				
				if (Ejemplo[cont].GetType() == typeof(char)) 
					Console.WriteLine(" es un caracter");
				
				if (Ejemplo[cont].GetType() == typeof(double)) 
					Console.WriteLine(" es un real");
				
				if (Ejemplo[cont].GetType() == typeof(string)) 
					Console.WriteLine(" es una cadena");
				
				if (Ejemplo[cont].GetType() == typeof(bool)) 
